...
var love_note_prompt = Game.Prompt.new("OMG write Tyler a SECRET love note to leave on his desk later!", "love_note_submitted", "countdown", 60.0, false, {"big": "私の心を動かしてくださいdokidoki"})
